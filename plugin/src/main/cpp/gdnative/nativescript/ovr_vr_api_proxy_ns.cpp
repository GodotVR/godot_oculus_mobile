...
void register_gdnative_vr_api_proxy(void *p_handle) {
	...
	{ // register all the functions that we want to expose via the OvrVrApiProxy class in GDScript
		...
		godot::nativescript_api->godot_nativescript_register_method(p_handle, kClassName, "vrapi_set_property_int", attributes, method);
		method.method = &vrapi_set_property_float;
		godot::nativescript_api->godot_nativescript_register_method(p_handle, kClassName, "vrapi_set_property_float", attributes, method);
		method.method = &vrapi_get_property_int;
		godot::nativescript_api->godot_nativescript_register_method(p_handle, kClassName, "vrapi_get_property_int", attributes, method);
		
		method.method = &vrapi_get_system_property_int;
		godot::nativescript_api->godot_nativescript_register_method(p_handle, kClassName, "vrapi_get_system_property_int", attributes, method);
		method.method = &vrapi_get_system_property_float;
		godot::nativescript_api->godot_nativescript_register_method(p_handle, kClassName, "vrapi_get_system_property_float", attributes, method);
		
		method.method = &vrapi_get_system_status_int;
		godot::nativescript_api->godot_nativescript_register_method(p_handle, kClassName, "vrapi_get_system_status_int", attributes, method);
		method.method = &vrapi_get_system_status_float;
		godot::nativescript_api->godot_nativescript_register_method(p_handle, kClassName, "vrapi_get_system_status_float", attributes, method);

		method.method = &vrapi_get_hand_pose;
		godot::nativescript_api->godot_nativescript_register_method(p_handle, kClassName, "vrapi_get_hand_pose", attributes, method);
...
GDCALLINGCONV godot_variant vrapi_set_property_int(godot_object *p_instance, void *p_method_data, void *p_user_data, int p_num_args, godot_variant **p_args) {
	CHECK_OVR(
		ovrProperty propType = (ovrProperty)godot::api->godot_variant_as_int(p_args[0]);
	    int propValue = godot::api->godot_variant_as_int(p_args[1]);
	    vrapi_SetPropertyInt(ovr_java, propType, propValue);
	    godot::api->godot_variant_new_bool(&ret, true); // there seams to be no error handling for the VrApi SetProperty function so we just return true here
	)
}
...
GDCALLINGCONV godot_variant vrapi_set_property_float(godot_object *p_instance, void *p_method_data, void *p_user_data, int p_num_args, godot_variant **p_args) {
	CHECK_OVR(
		ovrProperty propType = (ovrProperty)godot::api->godot_variant_as_int(p_args[0]);
	    godot_real propValue = godot::api->godot_variant_as_real(p_args[1]);
...
GDCALLINGCONV godot_variant vrapi_get_property_int(godot_object *p_instance, void *p_method_data, void *p_user_data, int p_num_args, godot_variant **p_args) {
	CHECK_OVR(
		...
		if (valid) {
			godot::api->godot_variant_new_int(&ret, prop);
		} else {
			godot::api->godot_variant_new_nil(&ret); // return nil when the query was invalid
		}
	)
}
...
GDCALLINGCONV godot_variant vrapi_get_system_property_int(godot_object *p_instance, void *p_method_data, void *p_user_data, int p_num_args, godot_variant **p_args) {
	CHECK_OVR(
		ovrSystemProperty propType = (ovrSystemProperty)godot::api->godot_variant_as_int(p_args[0]);
...
GDCALLINGCONV godot_variant vrapi_get_system_property_float(godot_object *p_instance, void *p_method_data, void *p_user_data, int p_num_args, godot_variant **p_args) {
	CHECK_OVR(
		...
		godot::api->godot_variant_new_real(&ret, prop);
	)
}
...
GDCALLINGCONV godot_variant vrapi_get_system_status_int(godot_object *p_instance, void *p_method_data, void *p_user_data, int p_num_args, godot_variant **p_args) {
	CHECK_OVR(
		ovrSystemStatus statusType = (ovrSystemStatus)godot::api->godot_variant_as_int(p_args[0]);
		int status = vrapi_GetSystemStatusInt(ovr_java, statusType);
		godot::api->godot_variant_new_int(&ret, status);
	)
}
...
GDCALLINGCONV godot_variant vrapi_get_system_status_float(godot_object *p_instance, void *p_method_data, void *p_user_data, int p_num_args, godot_variant **p_args) {
	CHECK_OVR(
		...
		godot::api->godot_variant_new_real(&ret, status);
	)
}
	...
	CHECK_OVR(
		...
		if (pController != nullptr) {
			...
			if (pState != nullptr && pState->connected) {
				...
				godot_array rotations = godot::api->godot_variant_as_array(p_args[1]);

				if (godot::api->godot_array_size(&rotations) != ovrHandBone_Max) {
					ALOGE("get_hand_pose(...) expect p_args[1] to be an array of size %d; got %d.", ovrHandBone_Max, godot::api->godot_array_size(&rotations));
				} else {
					...
					for (int i = 0; i < ovrHandBone_Max; i++) {
						...
						godot::api->godot_quat_new(&g_quat, ovr_quat.x, ovr_quat.y, ovr_quat.z, ovr_quat.w);
						godot::api->godot_variant_new_quat(&v_quat, &g_quat);
						godot::api->godot_array_set(&rotations, i, &v_quat);
					}

					godot::api->godot_variant_new_bool(&ret, true);
				}
			}
		}
	)
