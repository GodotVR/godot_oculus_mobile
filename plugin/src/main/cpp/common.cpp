...
void godot_transform_from_ovrMatrix(godot_transform *p_dest,
    ...
    godot::api->godot_vector3_new(&origin,
                                  _matrix.M[0][3] * p_world_scale,
                                  _matrix.M[1][3] * p_world_scale,
                                  _matrix.M[2][3] * p_world_scale);
...
void godot_transform_from_ovr_pose(godot_transform *dest,
    ...
    godot::api->godot_quat_new(
            &q, pose.Orientation.x, pose.Orientation.y, pose.Orientation.z, pose.Orientation.w);
    godot::api->godot_basis_new_with_euler_quat(&basis, &q);

    godot::api->godot_vector3_new(&origin,
                                  pose.Position.x * world_scale,
                                  pose.Position.y * world_scale,
